...
from handlers import (
    start, help_command, create_capsule_command, view_capsules_command,
    add_recipient_command, send_capsule_command, delete_capsule_command,
    edit_capsule_command, view_recipients_command, select_send_date,
    support_author, change_language, handle_language_selection,
    handle_text, handle_inline_selection, handle_date_buttons,
    handle_delete_confirmation, handle_send_confirmation,
    handle_content_buttons, handle_select_send_date, handle_recipient,
    handle_send_capsule_logic, handle_edit_capsule_content,
    handle_photo, handle_video, handle_audio, handle_document,
    handle_sticker, handle_voice, handle_edit_content_buttons
)
...
if __name__ == "__main__":
    from config import start_services
    start_services()
    asyncio.run(main())

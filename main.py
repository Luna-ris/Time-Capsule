...
# Состояния беседы
CAPSULE_TITLE, CAPSULE_CONTENT, SCHEDULE_TIME, ADD_RECIPIENT, SELECTING_SEND_DATE, ADDING_RECIPIENT, SELECTING_CAPSULE_FOR_RECIPIENTS, CREATING_CAPSULE, ENTERING_CUSTOM_DATE, SELECTING_CAPSULE = range(9)
